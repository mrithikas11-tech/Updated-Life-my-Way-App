...
public class Expense {
    ...
    public Expense(double amount, Category category, PaymentMethod paymentMethod,
                   String description, String vendor, LocalDate date) {
        this.amount = amount;
    ...
    public static class ExpenseBuilder {
        ...
        public ExpenseBuilder paymentMethod(PaymentMethod paymentMethod) { this.paymentMethod = paymentMethod; return this; }
        public ExpenseBuilder description(String description) { this.description = description; return this; }
        public ExpenseBuilder vendor(String vendor) { this.vendor = vendor; return this; }
        public ExpenseBuilder date(LocalDate date) { this.date = date; return this; }

        public Expense build() {
            if (amount <= 0) throw new IllegalArgumentException("Amount must be greater than 0");
            if (category == null) throw new IllegalArgumentException("Category must be provided");
            if (paymentMethod == null) throw new IllegalArgumentException("Payment method must be provided");
